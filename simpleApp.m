...
% 
% uilabel(fig, 'Text', 'Output units: cm and sec', 'Position', [350 390 160 30],...
%     'FontSize',14,'FontName','times');

uilabel(fig, 'Text', '$M_w$','Interpreter','latex', 'Position', [15 490 60 20]);
Mw = uieditfield(fig, 'numeric', 'Position', [80 490 40 20], 'Limits', [0 8],...
                      'LowerLimitInclusive','on',...
                      'UpperLimitInclusive','on',...
                      'Value', 0);

uilabel(fig, 'Text', '$R_{JB}\:(km)$','Interpreter','latex', 'Position', [15 465 60 20]);
RJB = uieditfield(fig, 'numeric', 'Position', [80 465 40 20], 'Limits', [0 200],...
                      'LowerLimitInclusive','on',...
                      'UpperLimitInclusive','on',...
                      'Value', 0);

uilabel(fig, 'Text', '$V_{S30}\:(m/s)$','Interpreter','latex', 'Position', [15 440 60 20]);
VS30 = uieditfield(fig, 'numeric', 'Position', [80 440 40 20], 'Limits', [0 1380],...
                      'LowerLimitInclusive','on',...
                      'UpperLimitInclusive','on',...
                      'Value', 0);
...
% FM = uieditfield(fig, 'numeric', 'Position', [80 390 40 20],'Value', 1);
